...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, low_sem_dim: int, high_sem_dim: int):
    ...
    def capture(self):
        ...
        return self.feat_cnn.state_dict()
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        sems = torch.zeros((fused_point_cloud.shape[0], self.low_sem_dim), device="cuda")
        ...
        self._sem = nn.Parameter(sems.requires_grad_(True))
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': [self._sem], 'lr': training_args.feature_lr / 40.0, "name": "sem"},
            {'params': [self._opacity], 'lr': training_args.opacity_lr, "name": "opacity"},
            {'params': [self._scaling], 'lr': training_args.scaling_lr, "name": "scaling"},
            {'params': [self._rotation], 'lr': training_args.rotation_lr, "name": "rotation"},
            {'params': [p for n, p in self.feat_cnn.named_parameters()], 'lr': training_args.feature_lr / 40.0, "name": "feat_cnn"}
        ]
    ...
    def save_ply(self, path):
        ...
        sem = self._sem.detach().cpu().numpy()
    ...
    def load_ply(self, path):
        ...
        if len(sem_names) == 0:
            sems = np.zeros((xyz.shape[0], self.low_sem_dim))
        else:
    ...
    def densification_postfix(self, new_xyz, new_features_dc, new_features_rest, new_sem, new_opacities, new_scaling, new_rotation):
        d = {"xyz": new_xyz,
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_sem, new_opacity, new_scaling, new_rotation)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        self.densification_postfix(new_xyz, new_features_dc, new_features_rest, new_sem, new_opacities, new_scaling, new_rotation)
